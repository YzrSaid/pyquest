    ...
    activities: [
      {
        ...
        story:
          "We left our accommodation in QC at 1:00 AM for the 6-hour trip. Our tour guide, Kuya Jero, chose Marcos Highway over Kennon Road—even though it’s longer, it's much safer for a bus, which I totally appreciated since I was asleep most of the way! We woke up around 5:00 AM as we entered the Benguet area, and the temperature drop was instant.\n\nWe arrived at the Strawberry Farm by 6:00 AM. It was cold, so my OJT jacket was a lifesaver. We spent the morning picking strawberries (100–150 PHP per kilo) and grabbing 50-peso strawberry taho. Kuya Jero gave us a great tip to buy our souvenirs here; he explained that the local shops connected to their route offer better prices, and he was right—prices here were noticeably lower than what we saw in other tourist spots later on. It was a great, relaxed start to our time in the North.",
        feelings:
